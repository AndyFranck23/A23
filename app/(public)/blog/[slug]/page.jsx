...
export async function generateMetadata({ params }) {
    try {
        ...
        return {
            ...
            description: article?.meta_description || 'Découvrez notre sélection exclusive de chocolats fins et produits d\'affiliation de qualité',
            robots: article?.status == 1 ? 'index, follow' : 'noindex, nofollow'
            // openGraph: {
        ...
        return (
            <div>
                <section
                    ...
                    style={{ backgroundImage: `url('${article?.image[0]}')` }}
                >
                ...
                <section className='bg-gray-50 dark:bg-gray-900 dark:text-gray-200 py-20'>
                    {article?.content ? (
                        <div className="overflow-x-auto max-w-none sm:mx-[100px] mx-5">
                            <div className="no-tailwind" dangerouslySetInnerHTML={{ __html: article.content }} />
                        </div>
                    ) : (
